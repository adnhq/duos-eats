        ...
        <main className="max-w-7xl mx-auto px-4 py-24 space-y-24">
          <section className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Transform your dining experience with exclusive savings at the
              best restaurants across the country. Duos Eats brings you a
              seamless way to enjoy premium dining while keeping more money in
              your pocket!
            </p>
          </section>
